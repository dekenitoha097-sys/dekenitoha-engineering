...
const projectsList = [
  {
    ...
    descFr: "Pentest d'une infrastructure complète incluant énumération de services (SSH, FTP, Samba), exploitation de vulnérabilités avec Metasploit, escalade de privilèges et lateral movement. Documentation attaque/défense complète.",
    descEn: "Full infrastructure pentest including service enumeration (SSH, FTP, Samba), vulnerability exploitation with Metasploit, privilege escalation and lateral movement. Complete attack/defense documentation.",
    ...
    demo: "",
    featured: true,
    featuresFr: ["Énumération de services", "Exploitation Metasploit", "Escalade de privilèges", "Lateral movement"],
    featuresEn: ["Service enumeration", "Metasploit exploitation", "Privilege escalation", "Lateral movement"]
  },
  {
    id: "burp-web-pentest",
    titleFr: "Pentest Web – Burp Suite",
    titleEn: "Web Pentest – Burp Suite",
    descFr: "Tests de sécurité web basés sur OWASP Top 10 : XSS (Reflected, Stored, DOM), SQL Injection, CSRF, XXE, SSRF, authentication bypass et fuzzing avec exploitation chaînée. Rapport technique complet.",
    descEn: "Web security testing based on OWASP Top 10: XSS (Reflected, Stored, DOM), SQL Injection, CSRF, XXE, SSRF, authentication bypass and chained exploitation. Complete technical report.",
    category: "cybersecurity",
    ...
    demo: "",
    featured: true,
    featuresFr: ["Injection SQL", "XSS Stored/Reflected", "CSRF & XXE", "Authentication bypass"],
    featuresEn: ["SQL Injection", "XSS Stored/Reflected", "CSRF & XXE", "Authentication bypass"]
  },
  {
    id: "nginx-hardening",
    titleFr: "Sécurisation Serveur Nginx/Apache2",
    titleEn: "Nginx/Apache2 Server Hardening",
    descFr: "Hardening serveur en environnement de production : configuration SSL/TLS, gestion SSH sécurisée, firewall (iptables), WAF et fail2ban, monitoring et logs. Sécurité complète du serveur.",
    descEn: "Production server hardening: SSL/TLS configuration, secure SSH management, firewall (iptables), WAF and fail2ban, monitoring and logs. Complete server security.",
    category: "cybersecurity",
    ...
    demo: "",
    featured: false,
    featuresFr: ["SSL/TLS Configuration", "SSH fort", "Firewall iptables", "WAF & fail2ban"],
    featuresEn: ["SSL/TLS Configuration", "Strong SSH", "iptables Firewall", "WAF & fail2ban"]
  },
  {
    id: "ctf-challenges",
    titleFr: "Résolution CTF – TryHackMe & picoCTF",
    titleEn: "CTF Challenges – TryHackMe & picoCTF",
    descFr: "Résolution de challenges en cybersécurité : énumération, exploitation, escalade de privilèges, reverse engineering, cryptographie et forensique. Plus de 50 challenges complétés avec documentation.",
    descEn: "Cybersecurity challenge resolution: enumeration, exploitation, privilege escalation, reverse engineering, cryptography and forensics. 50+ challenges completed with documentation.",
    category: "cybersecurity",
    ...
    demo: "",
    featured: false,
    featuresFr: ["Énumération avancée", "Reverse Engineering", "Cryptographie", "Forensique"],
    featuresEn: ["Advanced enumeration", "Reverse Engineering", "Cryptography", "Forensics"]
  },
  {
    id: "breakout_game",
