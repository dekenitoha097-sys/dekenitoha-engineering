const cv = {
  fr: {
    ...
    "cv.name": "DEKENI Toha",
    "cv.role": "Étudiant en 2e année d'ingénierie informatique et IA",
    "cv.location": "Casablanca, Maroc",
    "cv.email": "t.dekeni@hestim.ma",
    "cv.phone": "+228 724-477160",
    "cv.profile.title": "Profil",
    "cv.profile.text":
      "Étudiant en ingénierie informatique et IA, passionné par la cybersécurité, le développement logiciel et l’IA. Expérience en développement web (React/Next.js), programmation (C/C++/Python) et analyse de données. Autonome et rigoureux, j’aime résoudre des problèmes techniques et travailler en équipe.",

    "cv.education.title": "Formation",
    "cv.education.1.period": "2025 - 2026 (En cours)",
    "cv.education.1.degree": "2e année - Informatique & Intelligence artificielle",
    "cv.education.1.school": "HESTIM Casablanca",
    "cv.education.1.desc":
      "Développement web, bases de données, réseaux, architecture des ordinateurs, automate programmable.",
    "cv.education.2.period": "2024 - 2025",
    "cv.education.2.degree": "1re année - Informatique",
    "cv.education.2.school": "HESTIM Casablanca",
    "cv.education.2.desc":
      "Programmation, structures de données, algorithmes, bases de données, communication.",
    "cv.education.3.period": "2023 - 2024",
    "cv.education.3.degree": "Baccalauréat scientifique",
    "cv.education.3.school": "Lycée de Sokodé, Togo",
    "cv.education.3.desc":
      "Baccalauréat scientifique obtenu à Sokodé (Togo), mention Bien.",

    "cv.experience.title": "Expérience",
    "cv.projects.title": "Projets",
    "cv.category.label": "CV par domaine",
    "cv.category.general": "Général",
    "cv.category.web": "Web",
    "cv.category.ai": "IA",
    "cv.category.games": "Jeux",
    "cv.category.nodejs": "Dev Node.js",
    "cv.category.cyber": "Cybersécurité",
    ...
    "cv.skills.frameworks": "Frameworks & bibliothèques",
    "cv.skills.databases": "Bases de données",
    "cv.skills.api": "API & authentification",
    "cv.skills.tools": "Outils & DevOps",
    "cv.skills.other": "Autres",
    "cv.skills.ai": "Intelligence artificielle",

    "cv.softskills.title": "Compétences comportementales",
    "cv.softskills.list": "Travail d'équipe|Communication|Résolution de problèmes|Apprentissage autonome|Gestion de projets|Veille technologique",
    ...
    "cv.interests.list":
      "Cybersécurité|Innovation technologique|Open source & communauté dev|Intelligence artificielle|Design UI/UX|Dessin|Modélisation 3D",
  },
  en: {
    "cv.eyebrow": "CURRICULUM VITAE",
    "cv.title": "My",
    ...
    "cv.name": "DEKENI Toha",
    "cv.role": "2nd-year Computer Science and AI Engineering Student",
    "cv.location": "Casablanca, Morocco",
    "cv.email": "dekenitoha097@gmail.com",
    "cv.phone": "+228 724-477160",
    "cv.profile.title": "Profile",
    "cv.profile.text":
      "Computer science and AI engineering student focused on web/software development. Hands-on experience with React/Next.js, C/C++/Python, and data analysis. Detail-oriented and collaborative, I enjoy solving technical problems and building clean, performant software.",
    ...
    "cv.education.1.school": "HESTIM Casablanca",
    "cv.education.1.desc":
      "Web development, databases, networking, computer architecture, PLC basics.",
    "cv.education.2.period": "2024 - 2025",
    "cv.education.2.degree": "1st Year - Computer Science",
    "cv.education.2.school": "HESTIM Casablanca",
    "cv.education.2.desc":
      "Programming fundamentals, data structures, algorithms, databases, communication.",
    "cv.education.3.period": "2023 - 2024",
    "cv.education.3.degree": "Scientific Baccalaureate",
    "cv.education.3.school": "Sokode High School, Togo",
    "cv.education.3.desc":
    ...
    "cv.category.label": "CV by domain",
    "cv.category.general": "General",
    "cv.category.web": "Web",
    "cv.category.ai": "AI",
    "cv.category.games": "Games",
    "cv.category.nodejs": "Node.js Dev",
    "cv.category.cyber": "Cybersecurity",
    "cv.experience.1.period": "2024 - Present",
    ...
    "cv.skills.api": "API & Authentication",
    "cv.skills.tools": "Tools & DevOps",
    "cv.skills.other": "Other",
    "cv.skills.ai": "Artificial Intelligence",

    "cv.softskills.title": "Soft Skills",
    "cv.softskills.list": "Teamwork|Communication|Problem-solving|Autonomous learning|Project management|Technical curiosity",
